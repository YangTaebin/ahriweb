...
def ahristock_amount(univ_id):
    ...
    return_dict={}
    for i in stock_type:
        stock = pymysql.connect(host="localhost",user="root",passwd="taebin0408!", db=str(i))
...
def ahristock_bal():
    ...
    return_dict={}
    for i in stock_type:
        stock = pymysql.connect(host="localhost",user="root",passwd="taebin0408!", db="ahriweb")
        stock_cursor = stock.cursor(pymysql.cursors.DictCursor)
        sql = "select * from "+str(i)+";"
        stock_cursor.execute(sql)
        res = stock_cursor.fetchall()
...
def center_hav():
    ...
    return_dict={}
    for i in stock_type:
        stock = pymysql.connect(host="localhost",user="root",passwd="taebin0408!", db="center")
        stock_cursor = stock.cursor(pymysql.cursors.DictCursor)
        sql = "select * from "+str(i)+";"
        stock_cursor.execute(sql)
        res = stock_cursor.fetchall()
...
def add_tick_buy(type, amount):
    tick_buy = pymysql.connect(host="localhost",user="root",passwd="taebin0408!",db="tick_buy")
...
def add_tick_sell(type, amount):
    tick_sell = pymysql.connect(host="localhost",user="root",passwd="taebin0408!",db="tick_sell")
...
def new_balance_ahri():
    stock_type=["ahristock","stocka"]
    buy = pymysql.connect(host="localhost",user="root",passwd="taebin0408!",db="tick_buy")
    buy_cursor = buy.cursor(pymysql.cursors.DictCursor)
    sell = pymysql.connect(host="localhost",user="root",passwd="taebin0408!",db="tick_sell")
    ...
    for i in stock_type:
        ...
        sto_bal = pymysql.connect(host="localhost",user="root",passwd="taebin0408!",db="ahriweb")
